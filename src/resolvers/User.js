...
// This file is needed to define what to return for the
// "links" field in the User schema type (schema.graphlql)
...
// Here, we are trying to return an object of another type (links returns object of type 'LINK')
...
// links() is a Prisma defined promise that resolves to an array of objects in the links column
// from the db
